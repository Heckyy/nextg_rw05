$(document).ready(function () {
  ...
  $(window).load(function () {
    var po = document.getElementById("number").value;
    var data = "";
    data += "po=" + po;
    ...
    $.ajax({
      url:
        localStorage.getItem("data_link") + "/src/purchasing/proses/proses.php",
      method: "POST",
      data: data,
      type: "json",
      cache: false,
      ...
      success: function (data) {
        if (data == 1) {
          ...
          document.location.href =
            localStorage.getItem("data_link") + "/purchasing/edit/" + data;
        }
      },
    });
    return false;
    ...
    if (result.isConfirmed) {
      ...
      $.ajax({
        url:
          ...
          "/src/purchasing/proses/proses.php",
        method: "POST",
        data: data,
        type: "json",
        cache: false,
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      $.ajax({
        ...
        success: function (data) {
          document.location.href =
            localStorage.getItem("data_link") + "/purchasing/view/" + data;
        },
      });
