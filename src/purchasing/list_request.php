<?php
	class list_request_request{
		
		function data_list_request($db,$e,$library_class,$page){
			...
			if($_SESSION['request_new']==1){
				...
				$result = $db->select('tb_request','number_request LIKE "%'.$ubah_pencarian.'%" && tanggal LIKE "%'.$priod.'%" && status_purchasing="0" && status="1" || cluster LIKE "%'.$ubah_pencarian.'%" && tanggal LIKE "%'.$priod.'%" && status_purchasing="0" && status="1" || position LIKE "%'.$ubah_pencarian.'%" && tanggal LIKE "%'.$priod.'%" && status_purchasing="0" && status="1" || code_cluster LIKE "%'.$ubah_pencarian.'%" && tanggal LIKE "%'.$priod.'%" && status_purchasing="0" && status="1" || employee LIKE "%'.$ubah_pencarian.'%" && tanggal LIKE "%'.$priod.'%" && status_purchasing="0" && status="1"','id_request','DESC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/purchasing/js/jsproses_request.js"></script>
