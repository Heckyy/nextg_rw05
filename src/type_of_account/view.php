				...
				<div class="app-card-header p-3 main-content container-fluid">
				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
						...
						<div class="space_line row">
							...
							<div class="col-sm-2 col-lg-2">
								<input type="text" name="type_of_account" id="type_of_account" class="form-control square" value="<?php echo $v['type_of_account']; ?>" required="required" disabled>
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
						...
						<div class="space_line row">
							<div class="col-lg-12">
								...
								?>
										<a href="<?php echo $e; ?>/account/type-of-account/edit/<?php echo $code; ?>">
