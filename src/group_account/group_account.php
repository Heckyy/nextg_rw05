<?php
	class group_account{
		...
		function view_group_account($db,$e,$library_class,$view,$page){
			...
			if($_SESSION['account']==1){
				...
				$result = $db->select('tb_group_account','group_account LIKE "%'.$ubah_pencarian.'%" || position LIKE "%'.$ubah_pencarian.'%" || type_of_report LIKE "%'.$ubah_pencarian.'%"','group_account','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/group_account/js/jsproses.js"></script>
