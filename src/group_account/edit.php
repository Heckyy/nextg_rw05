	...
	class edit_group_account{
		...
		function edit_view($db,$e,$code){
			...
			if(mysqli_num_rows($view_account)>0 && $_SESSION['account_edit']==1){
				...
				$_SESSION['group_account']=$v['id_group_account'];
?>
				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
					<form method="POST" id="edit">
						<div class="space_line row">
							...
							<div class="col-sm-2 col-lg-2">
								<input type="text" name="group_account" id="group_account" class="form-control square" value="<?php echo $v['group_account']; ?>" required="required">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
