	...
	function view_data(){
		...
		var pag = $('#pagination').simplePaginator({
			...
			pageChange: function(page) {
				...
				console.log(data);
	            $.ajax({
					url:localStorage.getItem('data_link')+"/src/maintenance/proses/get_data_proses.php",
					method:"POST",
					data:data,
					type: 'json',
					cache:false,
...
function link_view(e){
	...
	document.location.href=localStorage.getItem('data_link')+"/maintenance/view/"+id;
}
