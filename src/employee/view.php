<?php
	class view_employee{
		...
		function data_view($db,$e,$code){
			...
			if(mysqli_num_rows($employee)>0 && $_SESSION['employee']==1){
				...
				<div class="app-card-header p-3 main-content container-fluid">
				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
						...
						<div class="space_line row">
							...
							<div class="col-sm-3 col-lg-3">
								<select id="unit" name="unit" class="choices form-select square bg-white" required="required" disabled="disabled">
							...
							<div class="col-sm-3 col-lg-3">
								<select id="position" name="position" class="choices form-select square bg-white" required="required" disabled="disabled">
									<option value="">Select</option>
									<?php
						...
						<div class="space_line row">
							...
							<div class="col-sm-3 col-lg-3">
								<select id="religion" name="religion" class="choices form-select square bg-white" required="required" disabled="disabled">
									<?php
										for($i=0; $i<=6; $i++){
									?>
							...
							<div class="col-sm-3 col-lg-3">
								<select id="sex" name="sex" class="choices form-select square bg-white" required="required" disabled="disabled">
									<?php
										for($i=0; $i<=1; $i++){
									?>
						...
						<div class="space_line row">
							...
							<div class="col-sm-3 col-lg-3">
								<input type="text" name="place_of_birth" id="place_of_birth" class="form-control square" value="<?php echo $v['place_of_birth']; ?>" required="required" disabled="disabled">
							</div>
							<div class="col-sm-2 col-lg-2" align="right">
								Tanggal Lahir
							</div>
							<div class="col-sm-3 col-lg-3">
								<input type="text" name="date_of_birth" id="date_of_birth" class="form-control square" value="<?php echo $date_of_birth; ?>" required="required" disabled="disabled">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
							...
							<div class="col-sm-3 col-lg-3">
								<input type="number" name="id_card" id="id_card" class="form-control square" value="<?php echo $v['id_card']; ?>" required="required" disabled="disabled">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
						...
						<div class="space_line row">
							...
							<div class="col-sm-3 col-lg-3">
								<input type="text" name="city" id="city" class="form-control square" value="<?php echo $v['city']; ?>" required="required" disabled="disabled">
							</div>
							<div class="col-sm-2 col-lg-2" align="right">
								Kode POS
							</div>
							<div class="col-sm-3 col-lg-3">
								<input type="number" name="postal_code" id="postal_code" class="form-control square" value="<?php echo $v['postal_code']; ?>" required="required" disabled="disabled">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
							...
							<div class="col-sm-3 col-lg-3">
								<input type="number" name="telp" id="telp" class="form-control square" value="<?php echo $v['telp']; ?>" disabled="disabled">
							</div>
							<div class="col-sm-2 col-lg-2" align="right">
								HP
							</div>
							<div class="col-sm-3 col-lg-3">
								<input type="number" name="hp" id="hp" class="form-control square" value="<?php echo $v['hp']; ?>" required="required" disabled="disabled">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
						...
						<div class="space_line row">
							<div class="col-lg-12">
								...
								?>
										<a href="<?php echo $e; ?>/employee/new">
											<button type="button" class="btn btn-sm btn-success btn-custom">New</button>
										</a>
								<?php
									}
									if($_SESSION['employee_edit']==1){
								?>
										<a href="<?php echo $e; ?>/employee/edit/<?php echo $code; ?>">
											<button type="button" class="btn btn-sm btn-warning btn-custom">Edit</button>
										</a>
								<?php
									}
									if($_SESSION['employee_access']==1){
								?>
										<a href="<?php echo $e; ?>/employee/access/<?php echo $code; ?>">
											<button type="button" class="btn btn-sm btn-info btn-custom">Akses</button>
										</a>
								<?php
									}
								?>
