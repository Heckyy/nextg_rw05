<?php
	class view_position{
		...
		function data_view($db,$e,$code){
			...
			if(mysqli_num_rows($view_position)>0 && $_SESSION['position']==1){
				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
						...
						<div class="space_line row">
							<div class="col-lg-12">
								...
								?>
										<a href="<?php echo $e; ?>/position/new">
											<button type="button" class="btn btn-sm btn-success btn-custom">New</button>
										</a>
								<?php
									}
									if($_SESSION['position_edit']==1){
								?>
										<a href="<?php echo $e; ?>/position/edit/<?php echo $code; ?>">
