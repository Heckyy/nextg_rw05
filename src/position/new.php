				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
					<form method="POST" id="new">
						<div class="space_line row">
							...
							<div class="col-sm-2 col-lg-2">
								<input type="text" name="code_position" id="code_position" class="form-control square" required="required">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
							...
							<div class="col-sm-2 col-lg-2">
								<input type="text" name="position" id="position" class="form-control square" required="required">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
