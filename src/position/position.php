<?php
	class position{
		...
		function view_position($db,$e,$library_class,$view,$page){
			...
			if($_SESSION['position']==1){
				...
				$result = $db->select('tb_position','code_position LIKE "%'.$ubah_pencarian.'%" || position LIKE "%'.$ubah_pencarian.'%"','position','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/position/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					<?php
						if($_SESSION['position_new']==1){
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/position/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
