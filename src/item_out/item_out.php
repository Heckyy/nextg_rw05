<?php
	class item_out{
		...
		function view_item_out($db,$e,$library_class,$view,$page){
...
?>
				...
				<script src="<?php echo $e; ?>/src/item_out/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					<div class="row justify-content-between align-items-center line">
						<div class="col-auto">
							<h6 class="app-card-title">
								Item Out <b>( <?php if(!empty($wr['warehouse'])) { echo $wr['warehouse']; } ?> )</b>
							</h6>
						</div>
					    <div class="col-auto">
					...
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/item-out/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
						...
						<table class="table mb-0">
						    <thead>
						        <tr>
						            ...
						            <td width="200PX">For</td>
						            <td width="150PX">Tipe Item Out</td>
						            <td>Note</td>
