<?php
	class view_item_out{
		...
		function data_view($db,$e,$library_class,$code){
			...
			$view_item_receipt_out=$db->select('tb_item_receipt_out','number_item_receipt_out="'.$view.'" && type_transaction="o"','id_item_receipt_out','DESC');
				...
				<div class="app-card-header p-3 main-content container-fluid">
					<div class="row justify-content-between align-items-center line">
						<div class="col-auto">
							<h6 class="app-card-title">
								Type of Out <b><?php echo $status; ?></b>
							</h6>
						</div>
						<?php 
							if($v['status']==0){
				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
						...
						<div class="space_line row">
							...
							<div class="col-sm-3 col-lg-3">
								<input type="text" name="untuk" id="untuk" value="<?php echo $v['from_for']; ?>" class="form-control square" required="required" disabled="disabled">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
						...
						<div class="space_line row">
							...
							<div class="space_line row">
								<div class="col-lg-12">
									...
									?>
										<a href="<?php echo $e; ?>/item-out/new">
											<button type="button" class="btn btn-sm btn-success btn-custom">New</button>
										</a>
									<?php
										}
										if($v['status']=='0' && $_SESSION['item_out_edit']==1){
									?>
											<a href="<?php echo $e; ?>/item-out/edit/<?php echo $code; ?>">
												<button type="button" class="btn btn-sm btn-warning btn-custom">Edit</button>
											</a>
									<?php
										}
										if($inputan==$sekarang && $v['status']!=='2' && $_SESSION['item_out_cancel']==1){
									?>
