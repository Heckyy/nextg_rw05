<?php
	class house_size{
		...
		function view_house_size($db,$e,$library_class,$view,$page){
			...
			if($_SESSION['house_size']==1){
				...
				$result = $db->select('tb_house_size','code_house_size LIKE "%'.$ubah_pencarian.'%" || house_size LIKE "%'.$ubah_pencarian.'%"','house_size','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/house_size/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/house-size/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
						...
						<table class="table mb-0">
						    <thead>
						        <tr>
						            ...
						            <td width="250px">House Size</td>
						            <td width="250px">Amount/m</td>
						            <td width="250px">Total IPL Macro</td>
						            <td>Note</td>
						        </tr>
						    </thead>
