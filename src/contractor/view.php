<?php
	class view_contractor{
		...
		function data_view($db,$e,$code){
			...
			if(mysqli_num_rows($view_contractor)>0 && $_SESSION['contractor']==1){
				...
				<div class="app-card-header p-3 main-content container-fluid">
				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
						...
						<div class="space_line row">
							...
							<div class="col-sm-2 col-lg-2">
								<input type="text" name="contractor" id="contractor" class="form-control square" value="<?php echo $v['contractor']; ?>" required="required" disabled>
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
							...
							<div class="col-sm-3 col-lg-3">
								<select id="type_of_work" name="type_of_work" class="form-control square bg-white" required="required" disabled="disabled">
						...
						<div class="space_line row">
							<div class="col-lg-12">
								...
								?>
										<a href="<?php echo $e; ?>/contractor/new">
											<button type="button" class="btn btn-sm btn-success btn-custom">New</button>
										</a>
								<?php
									}
									if($_SESSION['contractor_edit']==1){
								?>
										<a href="<?php echo $e; ?>/contractor/edit/<?php echo $code; ?>">
