<?php
	class contractor{
		...
		function view_contractor($db,$e,$library_class,$view,$page){
			...
			if($_SESSION['contractor']==1){
				...
				$result = $db->select('tb_contractor','code_contractor LIKE "%'.$ubah_pencarian.'%" || contractor LIKE "%'.$ubah_pencarian.'%"','contractor','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/contractor/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/contractor/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
						...
						<table class="table mb-0">
						    <thead>
						        <tr>
						            ...
						            <td width="250px">Kontraktor</td>
						            <td width="250px">Tipe Pekerjaan</td>
						            <td>Note</td>
						        </tr>
						    </thead>
