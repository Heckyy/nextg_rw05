<?php
	class type_of_payment{
		...
		function view_type_of_payment($db,$e,$library_class,$view,$page){

			if($_SESSION['type_of_payment']==1){
				...
				$result = $db->select('tb_type_of_payment','code_type_of_payment LIKE "%'.$ubah_pencarian.'%" || type_of_payment LIKE "%'.$ubah_pencarian.'%"','type_of_payment','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/type_of_payment/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/type-of-payment/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
