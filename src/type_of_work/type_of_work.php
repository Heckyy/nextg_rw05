<?php
	class type_of_work{
		...
		function view_type_of_work($db,$e,$library_class,$view,$page){
			...
			if($_SESSION['type_of_work']==1){
				...
				$result = $db->select('tb_type_of_work','code_type_of_work LIKE "%'.$ubah_pencarian.'%" || type_of_work LIKE "%'.$ubah_pencarian.'%"','type_of_work','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/type_of_work/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/type-of-work/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
