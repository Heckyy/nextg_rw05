<?php
	class get_invoice{
		...
		function view_get_invoice($db,$e,$library_class,$view,$page){
...
?>
				...
				<script src="<?php echo $e; ?>/src/cash_receipt/js/jsproses_warga.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					<div class="col" align="right">
						<a href="<?php echo $e; ?>/cash-receipt" class="btn btn-info btn-sm">
				           	Kembali
						</a>
					</div>
				</div>
