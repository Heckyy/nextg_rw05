	...
	class view_account{
		...
		function data_view($db,$e,$code){
			...
			if(mysqli_num_rows($view_account)>0 && $_SESSION['account']==1){
				...
				$sub_account=$db->select('tb_account','id_type_of_account="'.$v['id_type_of_account'].'" && id_sub_account="0"','id_account','DESC');
				...
				$_SESSION['id_account']=$v['id_account'];
				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
						<div class="space_line row">
							...
							<div class="col-sm-3 col-lg-3">
								<select id="type_of_account" name="type_of_account" onchange="account_sub();" class="form-control square bg-white" required="required" disabled="disabled">
						...
						<div class="space_line row">
							...
							<div class="col-sm-3 col-lg-3">
								<select id="sub_account_from" name="sub_account_from" class="form-control square bg-white" disabled="disabled">
									<option value="">Select</option>
									<?php
						...
						<div class="space_line row">
							...
							<div class="col-sm-3 col-lg-3">
								<select id="sub_account_from_2" name="sub_account_from_2" class="form-control square bg-white" disabled="disabled">
									<option value="">Select</option>
									<?php
						...
						<div class="space_line row">
							...
							<div class="col-sm-2 col-lg-2">
								<input type="text" name="account_number" id="account_number" class="form-control square" value="<?php echo $v['account_no']; ?>" required="required" disabled="disabled">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
							...
							<div class="col-sm-3 col-lg-3">
								<input type="text" name="account" id="account" class="form-control square" value="<?php echo $v['account']; ?>" required="required" disabled="disabled">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
							...
							<div class="col-sm-2 col-lg-2">
								<select id="position" name="position" class="form-control square bg-white" disabled="disabled">
						...
						<div class="space_line row">
							<div class="col-lg-12">
								...
								?>
										<a href="<?php echo $e; ?>/account/edit/<?php echo $code; ?>">
