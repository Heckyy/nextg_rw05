<?php
	class type_of_item{
		...
		function view_type_of_item($db,$e,$library_class,$view,$page){
			...
			if($_SESSION['type_of_item']==1){
				...
				$result = $db->select('tb_type_of_item','code_type_of_item LIKE "%'.$ubah_pencarian.'%" || type_of_item LIKE "%'.$ubah_pencarian.'%"','type_of_item','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/type_of_item/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/type-of-item/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
