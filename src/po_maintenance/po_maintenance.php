<?php
	class po_maintenance{
		
		function view_po_maintenance($db,$e,$library_class,$view,$page){
			...
			if($_SESSION['po_maintenance']==1){
				...
				$result = $db->select('tb_purchasing','type_of_purchase="2" && number_purchasing LIKE "%'.$ubah_pencarian.'%" && tanggal LIKE "%'.$priod.'%" || type_of_purchase="2" && note LIKE "%'.$ubah_pencarian.'%" && tanggal LIKE "%'.$priod.'%"','id_purchasing','DESC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/po_maintenance/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/po-maintenance/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
