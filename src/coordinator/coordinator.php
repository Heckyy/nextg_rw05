<?php
	class coordinator{
		...
		function view_coordinator($db,$e,$library_class,$view,$page){
			...
			if($_SESSION['coordinator']==1){
				...
				$result = $db->select('tb_coordinator','code_coordinator LIKE "%'.$ubah_pencarian.'%" || coordinator LIKE "%'.$ubah_pencarian.'%"','coordinator','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/coordinator/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/coordinator/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
						...
						<table class="table mb-0">
						    <thead>
						        <tr>
						            ...
						            <td width="250px">Koordinator</td>
						            <td>Catatan Starndar Kerja</td>
						        </tr>
						    </thead>
