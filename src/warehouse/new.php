				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
					<form method="POST" id="new">
						<div class="space_line row">
							...
							<div class="col-sm-2 col-lg-2">
								<input type="text" name="code_warehouse" id="code_warehouse" class="form-control square" required="required">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
							...
							<div class="col-sm-2 col-lg-2">
								<input type="text" name="warehouse" id="warehouse" class="form-control square" required="required">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
