<?php
	class warehouse{
		...
		function view_warehouse($db,$e,$library_class,$view,$page){
			...
			if($_SESSION['warehouse']==1){
				...
				$result = $db->select('tb_warehouse','code_warehouse LIKE "%'.$ubah_pencarian.'%" || warehouse LIKE "%'.$ubah_pencarian.'%"','warehouse','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/warehouse/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/warehouse/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
