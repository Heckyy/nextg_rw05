<?php
	class view_type_of_receipt_wh{
		...
		function data_view($db,$e,$code){
			...
			if(mysqli_num_rows($view_type_of_receipt_wh)>0 && $_SESSION['type_of_receipt_wh']==1){
				...
				<div class="app-card-header p-3 main-content container-fluid">
				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
						...
						<div class="space_line row">
							...
							<div class="col-sm-2 col-lg-2">
								<input type="text" name="type_of_receipt_wh" id="type_of_receipt_wh" class="form-control square" value="<?php echo $v['type_of_receipt_wh']; ?>" required="required" disabled>
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
						...
						<div class="space_line row">
							<div class="col-lg-12">
								...
								?>
										<a href="<?php echo $e; ?>/type-of-receipt-wh/new">
											<button type="button" class="btn btn-sm btn-success btn-custom">New</button>
										</a>
								<?php
									}
									if($_SESSION['type_of_receipt_wh_edit']==1){
								?>
										<a href="<?php echo $e; ?>/type-of-receipt-wh/edit/<?php echo $code; ?>">
...
?>
				<script type="text/javascript">
					document.location.href=localStorage.getItem('data_link')+"/type-of-receipt-wh";
				</script>
<?php
			}
		}
