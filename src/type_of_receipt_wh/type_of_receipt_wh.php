<?php
	class type_of_receipt_wh{
		
		function view_type_of_receipt_wh($db,$e,$library_class,$view,$page){
			...
			if($_SESSION['type_of_receipt_wh']==1){
				...
				$result = $db->select('tb_type_of_receipt_wh','code_type_of_receipt_wh LIKE "%'.$ubah_pencarian.'%" || type_of_receipt_wh LIKE "%'.$ubah_pencarian.'%"','type_of_receipt_wh','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/type_of_receipt_wh/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/type-of-receipt-wh/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
