<?php
	class edit_type_of_out_wh{
		...
		function edit_view($db,$e,$code){
			...
			if(mysqli_num_rows($view_type_of_out_wh)>0 && $_SESSION['type_of_out_wh_edit']==1){
				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
					<form method="POST" id="edit">
						...
						<div class="space_line row">
							...
							<div class="col-sm-2 col-lg-2">
								<input type="text" name="type_of_out_wh" id="type_of_out_wh" class="form-control square" value="<?php echo $v['type_of_out_wh']; ?>" required="required">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
...
?>
				<script type="text/javascript">
					document.location.href=localStorage.getItem('data_link')+"/type_of_out_wh";
				</script>
<?php
			}
		}
