<?php
	class type_of_out_wh{
		
		function view_type_of_out_wh($db,$e,$library_class,$view,$page){
			...
			if($_SESSION['type_of_out_wh']==1){
				...
				$result = $db->select('tb_type_of_out_wh','code_type_of_out_wh LIKE "%'.$ubah_pencarian.'%" || type_of_out_wh LIKE "%'.$ubah_pencarian.'%"','type_of_out_wh','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/type_of_out_wh/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/type-of-out-wh/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
						...
						<table class="table mb-0">
						    <thead>
						        <tr>
						            ...
						            <td width="250px">Jenis Pengeluaran</td>
						            <td>Note</td>
						        </tr>
						    </thead>
