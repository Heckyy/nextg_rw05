				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
					<form method="POST" id="new">
						<div class="space_line row">
							...
							<div class="col-sm-2 col-lg-2">
								<input type="text" name="code_type_of_out_wh" id="code_type_of_out_wh" class="form-control square" required="required">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
							...
							<div class="col-sm-2 col-lg-2">
								<input type="text" name="type_of_out_wh" id="type_of_out_wh" class="form-control square" required="required">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
