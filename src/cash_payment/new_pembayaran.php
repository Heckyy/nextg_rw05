<?php
	class new_pembayaran_cash_payment{
		
		function new_pembayaran_view($db,$e,$library_class){
				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
					<form method="POST" id="new_payroll">
						...
						<div class="space_line row">
							...
							<div class="col-sm-2 col-lg-3">
								<select id="jenis_uang_keluar" name="jenis_uang_keluar" onchange="jenis_transaksi()" class="form-control square bg-white" required="required">
									...
									<option value="1">Administrasi & Operasional</option>
						...
						<div class="space_line row">
							...
							<div class="col-sm-2 col-lg-3">
								<select id="cluster" name="cluster" class="form-control square bg-white" disabled="disabled">
									<option value="">Select</option>
						       		<?php
						             	foreach ($cluster as $key => $tr) {
						       		?>

						                    <option value="<?php echo 'C'.$tr['id_cluster']; ?>">
						...
						<div class="space_line row">
							...
							<div class="col-sm-3 col-lg-3">
								<input type="text" name="amount" id="amount" class="form-control square" disabled="disabled" required="required">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
							...
							<div class="col-sm-5 col-lg-5">
								<textarea  name="note" id="note" class="form-control square textarea-edit" disabled="disabled"></textarea>
							</div>
						</div>
						<div class="space_line row">
							<div class="col-lg-12">
