<?php
  ...
  if(!empty($_SESSION['id_employee']) && !empty($_GET['view'])){
    ...
    $payment=$db->select('tb_cash_receipt_payment','number="'.$ubah.'" && status="1" && type="o"','id_cash_receipt_payment','DESC');
    $i=mysqli_fetch_assoc($payment);
                  ...
                  <tr>
                    ...
                    <td width="39%" valign="top">
                      ...
                      <table border="0" class="table">
                        <tr><td colspan="2" align="center"><b>PEMBAYARAN</b></td></tr>
                        <tr>
                          <td width="50%">Date</td>
                          <td width="50%">: '.$date.'</td>
                        </tr>
