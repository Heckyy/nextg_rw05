<?php
	class item{
		...
		function view_item($db,$e,$library_class,$view,$page){
			...
			if($_SESSION['item']==1){
				...
				$result = $db->select('tb_item','code_item LIKE "%'.$ubah_pencarian.'%" || item LIKE "%'.$ubah_pencarian.'%"','item','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/item/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/item/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
