<?php
	class edit_request{
		...
		function edit_view($db,$e,$code){
			...
			$view_request=$db->select('tb_request','number_request="'.$view.'" && status="0"','id_request','DESC');

			if(mysqli_num_rows($view_request)>0 && $_SESSION['request_edit']==1){
				...
				$detail=$db->select('tb_request_detail INNER JOIN tb_item ON tb_request_detail.id_item=tb_item.id_item','tb_request_detail.number_request="'.$v['number_request'].'"','tb_request_detail.id_request_detail','DESC','tb_request_detail.id_request_detail,tb_request_detail.qty,tb_request_detail.note,tb_request_detail.unit,tb_item.item');
				 ...
				 <div class="app-card-body pb-3 main-content container-fluid">
					<form method="POST" id="edit">
						<div class="space_line row">
							...
							<div class="col-sm-2 col-lg-2">
								<input type="date" name="tanggalEdit" id="tanggalEdit" class="form-control square" required="required" value="<?php echo $date?>">
							</div>
						</div>
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
						...
						<div class="space_line row">
							<div class="col-sm-2 col-lg-2">
								Barang <a href="#" data-bs-toggle="modal" data-bs-target="#tambah_barang"><i class="bi bi-plus-circle"></i></a>
							</div>
