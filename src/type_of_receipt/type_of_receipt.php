<?php
	class type_of_receipt{
		
		function view_type_of_receipt($db,$e,$library_class,$view,$page){

			if($_SESSION['type_of_receipt']==1){
				...
				$result = $db->select('tb_type_of_receipt','code_type_of_receipt LIKE "%'.$ubah_pencarian.'%" || type_of_receipt LIKE "%'.$ubah_pencarian.'%"','type_of_receipt','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/type_of_receipt/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					<?php
						if($_SESSION['type_of_receipt_new']==1){
					?>
							<div class="col" align="right">
								<a href="<?php echo $e; ?>/type-of-receipt/new" class="btn btn-default btn-sm link-new">
						           	New
								</a>
							</div>
					<?php
						...
						<table class="table mb-0">
						    <thead>
						        <tr>
						            ...
						            <td width="250px">Jenis Penerimaan</td>
						            <td>Note</td>
						        </tr>
						    </thead>
