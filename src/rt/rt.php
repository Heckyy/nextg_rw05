<?php
	class rt{
		function view_rt($db,$e,$view,$page){
			...
			if($_SESSION['rt']==1){
				...
				$result = $db->select('tb_rt','number LIKE "%'.$ubah_pencarian.'%" || name_rt LIKE "%'.$ubah_pencarian.'%" || name_representative LIKE "%'.$ubah_pencarian.'%"','number','ASC');
...
?>
				...
				<script src="<?php echo $e; ?>/src/rt/js/jsproses.js"></script>
				<div class="app-card-header p-3 main-content container-fluid">
					...
					<div class="col" align="right">
						<a href="<?php echo $e; ?>/rt/new" class="btn btn-default btn-sm link-new">
				           	New
						</a>
					</div>
				</div>
						...
						<table class="table mb-0">
						    <thead>
						        <tr>
						            ...
						            <td width="100px">RT</td>
						            <td width="250px">Kepala RT</td>
						            <td width="250px">Wakil RT</td>
						            <td>Note</td>
						        </tr>
						    </thead>
