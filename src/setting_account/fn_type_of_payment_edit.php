						...
						<table class="table mb-0">
						    ...
						    <tbody>
						    	<?php
						    		if($totalRecords>0){
						    	?>
						    			<form method="POST" id="edit_fn_type_of_payment">
						    	<?php
						    			$no=1;
										foreach ($result as $key => $r) {
								...
								?>
											<tr>
												...
												<td>
													<select id="account_<?php echo $r['id_type_of_payment']; ?>" name="account_<?php echo $r['id_type_of_payment']; ?>" class="form-control square bg-white">
														<option value="">
															Select
														</option>
														<?php
