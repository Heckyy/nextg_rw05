<?php
	class fn_type_of_payment{
		
		function view_fn_type_of_payment($db,$e,$library_class,$view,$page){
...
?>
								$("#account_<?php echo $r['id_type_of_payment']; ?>").select2({
								    theme: "bootstrap-5",
								});
<?php
						}
					...
					<div class="row justify-content-between align-items-center line">
						<div class="col-auto">
							<h6 class="app-card-title">
								Account - Finance Type of Payment
							</h6>
						</div>
					</div>
					<?php
						    ...
						    <tbody>
								...
								?>
											<tr>
												...
												<td width="50%">
													<?php
														echo $r['type_of_payment'];
													?>
												</td>
												<td>
													<select id="account_<?php echo $r['id_type_of_payment']; ?>" name="account_<?php echo $r['id_type_of_payment']; ?>" class="form-control square" disabled="disabled">
														<option value="">
															Select
														</option>
														<?php
								...
								?>
									<tr>
										<td colspan="3" align="right" class="bg-white">
											<a href="<?php echo $e; ?>/account/fn/type-of-payment/edit">
