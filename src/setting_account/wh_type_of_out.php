<?php
	class wh_type_of_out{
		
		function view_wh_type_of_out($db,$e,$library_class,$view,$page){
...
?>
								$("#account_<?php echo $r['id_type_of_out_wh']; ?>").select2({
								    theme: "bootstrap-5",
								});
<?php
						}
						    ...
						    <tbody>
								...
								?>
											<tr>
												...
												<td width="50%">
													<?php
														echo $r['type_of_out_wh'];
													?>
												</td>
												<td>
													<select id="account_<?php echo $r['id_type_of_out_wh']; ?>" name="account_<?php echo $r['id_type_of_out_wh']; ?>" class="form-control square" disabled="disabled">
														<option value="">
															Select
														</option>
														<?php
								...
								?>
									<tr>
										<td colspan="3" align="right" class="bg-white">
											<a href="<?php echo $e; ?>/account/wh/type-of-out/edit">
