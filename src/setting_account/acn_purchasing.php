<?php
	class acn_purchasing{
		
		function view_acn_purchasing($db,$e,$library_class,$view,$page){
...
?>
								$("#account_<?php echo $r['id_type_of_purchasing']; ?>").select2({
								    theme: "bootstrap-5",
								});
<?php
						}
						    ...
						    <tbody>
								...
								?>
											<tr>
												...
												<td width="50%">
													<?php
														echo $r['type_of_purchasing'].' - <b>('.$r['type'].')</b>';
													?>
												</td>
												<td>
													<select id="account_<?php echo $r['id_type_of_purchasing']; ?>" name="account_<?php echo $r['id_type_of_purchasing']; ?>" class="form-control square" disabled="disabled">
														<option value="">
															Select
														</option>
														<?php
								...
								?>
									<tr>
										<td colspan="3" align="right" class="bg-white">
											<a href="<?php echo $e; ?>/account/pcg/purchasing/edit">
