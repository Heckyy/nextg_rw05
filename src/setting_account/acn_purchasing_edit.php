						...
						<table class="table mb-0">
						    ...
						    <tbody>
						    	<?php
						    		if($totalRecords>0){
						    	?>
						    			<form method="POST" id="edit_acn_purchasing">
						    	<?php
						    			$no=1;
										foreach ($result as $key => $r) {
								...
								?>
											<tr>
												...
												<td>
													<select id="account_<?php echo $r['id_type_of_purchasing']; ?>" name="account_<?php echo $r['id_type_of_purchasing']; ?>" class="form-control square bg-white">
														<option value="">
															Select
														</option>
														<?php
