<?php
	class fn_type_of_receipt{
		
		function view_fn_type_of_receipt($db,$e,$library_class,$view,$page){
						    ...
						    <tbody>
								...
								?>
											<tr>
												...
												<td>
													<select id="account_<?php echo $r['id_type_of_receipt']; ?>" name="account_<?php echo $r['id_type_of_receipt']; ?>" class="form-control square" disabled="disabled">
														<option value="">
															Select
														</option>
														<?php
								...
								?>
									<tr>
										<td colspan="3" align="right" class="bg-white">
											<a href="<?php echo $e; ?>/account/fn/type-of-receipt/edit">
